      ...
      <div className="ar-modal" style={{ maxWidth: 400, width: '100%' }} onClick={e => e.stopPropagation()}>
        <div style={{ padding: 32, display: 'flex', flexDirection: 'column', gap: 20 }}>
          ...
          {isNativePlatform ? (
            <div style={{
              padding: '10px 14px', borderRadius: 10,
              background: 'rgba(72,56,245,0.07)', border: '1px solid rgba(72,56,245,0.2)',
              fontSize: 12, color: 'var(--ar-muted)', textAlign: 'center',
            }}>
              Use email &amp; password to sign in on the mobile app.
            </div>
          ) : (
            <button
